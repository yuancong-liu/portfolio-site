...
export const IconsSp = () => {
  ...
  const cMarkPath = {
    hidden: {
      pathLength: 0,
      fill: `${colorScheme === 'light' ? '#150640' : '#fdfbf8'}00`,
    },
    visible: {
      pathLength: [0, 1, 1],
      fill: [
        `${colorScheme === 'light' ? '#150640' : '#fdfbf8'}00`,
        `${colorScheme === 'light' ? '#150640' : '#fdfbf8'}00`,
        colorScheme === 'light' ? '#150640' : '#fdfbf8',
      ],
      transition: {
        duration: 3,
        ease: 'easeInOut',
      ...
      <div className={styles['icons-wrapper']}>
        ...
        >
          <path
            ...
            fill={colorScheme === 'light' ? '#150640' : '#fdfbf8'}
          />
        </motion.svg>
        ...
        <motion.svg
          ...
          whileTap={{
            scale: 0.9,
            rotate: colorScheme === 'light' ? 45 : 360,
          }}
